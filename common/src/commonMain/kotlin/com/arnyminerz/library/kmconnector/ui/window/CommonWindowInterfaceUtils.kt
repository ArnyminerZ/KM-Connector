...
inline fun <reified T> CommonWindowInterface.getExtra(key: String): T? {
    val value = extras[key]
    // Check if result is serializable, then try fetching the value directly, or from string and converting to the class
